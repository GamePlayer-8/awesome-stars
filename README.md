...
- [itismoej/pingtunnel-client](https://github.com/itismoej/pingtunnel-client) - 
...
- [noricha-vr/WebScreen](https://github.com/noricha-vr/WebScreen) - 
...
- [leonchen83/redis-rdb-cli](https://github.com/leonchen83/redis-rdb-cli) - Redis RDB CLI: A command-line tool to parse, filter, split, and merge Redis RDB files, and to analyze memory usage offline. It also supports data synchronization between two Redis instances and   allo
...
- [nickuc-com/OpeNLogin](https://github.com/nickuc-com/OpeNLogin) - A practical, secure and friendly authentication plugin
...
- [eithan1231/minio-object-browser](https://github.com/eithan1231/minio-object-browser) - Minio Object Browser, avoid using ANY minio products if possible. Seek alternatives such as RustFS.
...
- [vayun-mathur/Alternative-Location-Services](https://github.com/vayun-mathur/Alternative-Location-Services) - alternative location services to GPS or Google Location Services for Android
...
- [librekeys/pico-fido-firmwares](https://github.com/librekeys/pico-fido-firmwares) - A custom build pico-fido firmware(s) with LibreKeys applied patches
...
- [firelzrd/kcompressd-unofficial](https://github.com/firelzrd/kcompressd-unofficial) - Asynchronous swapper (forked from the original Kcompressd)
- [adoptium/temurin17-binaries](https://github.com/adoptium/temurin17-binaries) - Temurin 17 binaries
...
- [flathub/org.gimp.GIMP](https://github.com/flathub/org.gimp.GIMP) - 
- [Luspin/uBlock-FilterLists](https://github.com/Luspin/uBlock-FilterLists) - 
...
- [nim65s/matrix-webhook](https://github.com/nim65s/matrix-webhook) - Post a message to a matrix room with a simple HTTP POST
- [isjerryxiao/pacroller](https://github.com/isjerryxiao/pacroller) - The "Unattended Upgrades" for Arch Linux.
- [quantum5/bird-filter](https://github.com/quantum5/bird-filter) - Quantum's composable filters and helpers for building a proper ASN
- [polhenarejos/pico-openpgp](https://github.com/polhenarejos/pico-openpgp) - OpenPGP CCID smart card for Raspberry Pico and ESP32
...
- [WeirdTreeThing/chromebook-linux-audio](https://github.com/WeirdTreeThing/chromebook-linux-audio) - Script that enables audio support on many Chrome devices running various Linux distros
...
- [Neocky/pluGET](https://github.com/Neocky/pluGET) - Powerful Package manager that updates plugins & server software for Minecraft servers
...
- [firelzrd/le9uo](https://github.com/firelzrd/le9uo) - [PATCH] mm: Protect the working set under memory pressure to prevent thrashing, avoid high latency and prevent livelock in near-OOM conditions
...
- [PunkPangolin/org.strawberrymusicplayer.strawberry](https://github.com/PunkPangolin/org.strawberrymusicplayer.strawberry) - 
...
- [hermeticbuild/hermetic-llvm](https://github.com/hermeticbuild/hermetic-llvm) - A zero sysroot, fully hermetic C/C++ cross compilation toolchain for Bazel based on LLVM.
